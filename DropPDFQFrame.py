import sys
from PyQt6.QtWidgets import QLabel, QFrame, QApplication, QPushButton
from catQListWidgetItem import catQListWidgetItem


class DropPDFQFrame(QFrame):
    ...
    def dropEvent(self, e):
        ...
        if len(fs):
            ...
            self.findChild(QLabel, "burstPdfLabel").setText(fs[0])
